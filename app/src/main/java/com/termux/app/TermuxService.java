...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/com.eltechs.ed/files";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_STOP_SERVICE.equals(action)) {
            ...
            if (mWakeLock == null) {
                ...
                mWifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, LOG_TAG);
                mWifiLock.acquire();
                ...
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (!pm.isIgnoringBatteryOptimizations(packageName)) {
                        ...
                        try {
                            ...
                            Log.e(LOG_TAG, "Failed to call ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS", e);
                        }
                    }
                }
            ...
            Log.e(LOG_TAG, "Unknown TermuxService action: '" + action + "'");
        }
    ...
    public void onDestroy() {
        ...
        if (termuxTmpDir.exists()) {
            try {
                ...
                Log.e(LOG_TAG, "Error while removing file at " + termuxTmpDir.getAbsolutePath(), e);
            }
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        if (executablePath == null) {
            if (!failSafe) {
                for (String shellBinary : new String[]{"login", "bash", "zsh"}) {
                    ...
                    boolean canExecute = shellFile.canExecute();
                    Log.i(LOG_TAG, shellFile.getAbsolutePath() + " canExecute: " + canExecute);
                    if (canExecute) {
        ...
        Log.i(LOG_TAG, "executablePath: " + executablePath);

        String[] processArgs = BackgroundJob.setupProcessArgs(executablePath, arguments);
        Log.i(LOG_TAG, "processArgs: " + Arrays.toString(processArgs));
