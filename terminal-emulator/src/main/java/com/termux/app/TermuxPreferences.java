...
final class TermuxPreferences {
    ...
    private static final int SHORTCUT_ACTION_CREATE_SESSION = 1;
    private static final int SHORTCUT_ACTION_NEXT_SESSION = 2;
    private static final int SHORTCUT_ACTION_PREVIOUS_SESSION = 3;
    private static final int SHORTCUT_ACTION_RENAME_SESSION = 4;
